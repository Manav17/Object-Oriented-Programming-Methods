...
public:
    linkedlistSSJ ();
    void addmiddle ();
    void find (); //Change This If Data Changes
    void edit ();
    void remove ();
...
void linkedlistSSJ::find()
{
    TEMP = FIRST;
    
    FIND = icin("Search Integer");
...
void linkedlistSSJ2::write()
{
    ...
    fout.open ("/Users/manavjotsingh/Documents/CSCI/CSCI 15/LinkedList/LinkedList/Data", ios::out); //*****
...
void linkedlistSSJ2::read()
{
    ...
    fin.open("/Users/manavjotsingh/Documents/CSCI/CSCI 15/LinkedList/LinkedList/Data", ios::in); //*****
